...
[latest_release]: https://github.com/PiotrMachowski/Home-Assistant-custom-components-Obegransad/releases/latest
[releases_shield]: https://img.shields.io/github/release/PiotrMachowski/Home-Assistant-custom-components-Obegransad.svg?style=popout

[releases]: https://github.com/PiotrMachowski/Home-Assistant-custom-components-Obegransad/releases
[downloads_total_shield]: https://img.shields.io/github/downloads/PiotrMachowski/Home-Assistant-custom-components-Obegransad/total
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=obegransad)
...
To install this integration manually you have to download [*obegransad.zip*](https://github.com/PiotrMachowski/Home-Assistant-custom-components-Obegransad/releases/latest/download/obegransad.zip) and extract its contents to `config/custom_components/obegransad` directory:
```bash
